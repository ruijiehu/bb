...
添加足迹 */
  ...
  torenzhen(e) {
    ...
    wx.navigateTo({
      url: '/pages/my/verify?id=' + id + '&type=1'
    })
  },
  /**
   * 认证学历
  ...
  torenzhen_edu (e) {
    let id = e.currentTarget.dataset.id;
    wx.navigateTo({
      url: '/pages/my/verify?id=' + id + '&type=2'
    })
  },
  /**
  * 编辑教育经历
  ...
  */
  bianji_work(e) {
    ...
    let ttt = e.currentTarget.dataset.t;
    let eee = e.currentTarget.dataset.e;
    let isok = e.currentTarget.dataset.isok;
    let ex = e.currentTarget.dataset.ex
    wx.navigateTo({
      url: '/pages/mine/work_list/edit_work?id=' + id + '&company=' + company + '&position=' + position + '&t=' + ttt + '&e=' + eee + '&isok=' + isok + '&ex=' + ex
    })
  }
})